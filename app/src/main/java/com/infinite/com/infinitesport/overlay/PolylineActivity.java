package com.infinite.com.infinitesport.overlay;
...
//		addPolylineInPlayGround();
	...
	private void addPolylinesWithTexture() {
		...
		texTuresList.add(BitmapDescriptorFactory.fromResource(R.mipmap.custtexture));
		texTuresList.add(BitmapDescriptorFactory.fromResource(R.mipmap.map_alr_night));
